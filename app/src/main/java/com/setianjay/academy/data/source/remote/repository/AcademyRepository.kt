...
class AcademyRepository private constructor(private val remoteDataSource: RemoteDataSource) :
    ...
    override fun getAllModules(courseId: String): LiveData<List<ModuleEntity>> {
        ...
        remoteDataSource.getAllModules(courseId, object : LoadModulesCallback {
            ...
            override fun onAllModulesReceived(modules: List<ModuleResponse>) {
                for (i in modules) {
                    if (moduleId == i.moduleId) {
                        ...
                        remoteDataSource.getContent(moduleId, object : LoadContentModule {
    ...
    companion object {
        ...
        fun getInstance(remoteDataSource: RemoteDataSource): AcademyRepository {
            return INSTANCE ?: synchronized(this) {
                val instance = AcademyRepository(remoteDataSource)
                INSTANCE = instance
                instance
            }
        }
