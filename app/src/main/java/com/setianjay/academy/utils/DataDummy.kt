...
object DataDummy {
    ...
    fun generateDummyCourses(): List<CourseEntity>{
        ...
        courseList.add(CourseEntity("a14",
        ...
        courseList.add(CourseEntity("a55",
        ...
        courseList.add(CourseEntity("a47",
        ...
        courseList.add(CourseEntity("a74",
        ...
        courseList.add(CourseEntity("a51",
    ...
    fun generateDummyModules(courseId: String): List<ModuleEntity>{
        ...
        moduleList.add(ModuleEntity(
            ...
            0, false))
        moduleList.add(ModuleEntity("{$courseId}m2",
            courseId,
            "Modul 1 : Teori 1",
            1, false))
        moduleList.add(ModuleEntity("{$courseId}m3",
            courseId,
            "Latihan 1",
            2, false))
        moduleList.add(ModuleEntity("{$courseId}m4",
            courseId,
            "Bedah Kode 1",
            3, false))
        moduleList.add(ModuleEntity("{$courseId}m5",
            courseId,
            "Modul 2 : Teori 2",
            4, false))

        moduleList.add(ModuleEntity("{$courseId}m6",
            courseId,
            "Latihan 2",
            5, false))

        moduleList.add(ModuleEntity("{$courseId}m7",
            courseId,
            "Bedah Kode 2",
            6, false))
